...
/**
 * @see <a href="https://github.com/Kitware/VTK/blob/master/Examples/Android/JavaVTK/src/com/kitware/JavaVTK/JavaVTKView.java">...</a>
...
public class VTKView extends GLSurfaceView {
    private static final String TAG = "JavaVTKView";
    private final Renderer myRenderer;

    public VTKView(Context context, VTKLib vtkLib) {
        super(context);
        setFocusable(true);
        ...
        this.myRenderer = new Renderer(vtkLib);
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        private final VTKLib vtkLib;

        public Renderer(VTKLib vtkLib) {
            this.vtkLib = vtkLib;
        }

        public void onDrawFrame(GL10 gl) {
            vtkLib.libRender(vtkContext);
        }

        // forward events to VTK for it to handle
        public void onKeyEvent(boolean down, KeyEvent ke) {
            vtkLib.libOnKeyEvent(vtkContext, down, ke.getKeyCode(),
                    ke.getMetaState(),
                    ke.getRepeatCount());
        }
        ...
        public void onMotionEvent(final MotionEvent me) {
            try {
                ...
                vtkLib.libOnMotionEvent(vtkContext,
                        actionMasked,
                        actionId,
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            vtkContext = vtkLib.libInit(width, height);
        }
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        queueEvent(() -> myRenderer.onKeyEvent(false, keyEvent));
        return true;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        final KeyEvent keyEvent = event;
        queueEvent(() -> myRenderer.onKeyEvent(true, keyEvent));
        return true;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        queueEvent(() -> myRenderer.onMotionEvent(motionEvent));
        return true;
    }

    public interface VTKLib {
         ...
         */
        long libInit(int width, int height);

        void libRender(long udp);

        void libOnKeyEvent(long udp, boolean down, int keyCode,
                           int metaState,
                           int repeatCount);

        void libOnMotionEvent(long udp,
                              int action,
                              int eventPointer,
                              int numPtrs,
